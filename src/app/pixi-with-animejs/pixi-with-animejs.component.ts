...
@Component({
  selector: 'app-pixi-with-animejs',
  templateUrl: './pixi-with-animejs.component.html',
  styleUrls: ['./pixi-with-animejs.component.scss']
})
export class PixiWithAnimejsComponent implements OnInit {
  ...
  loaded() {
    ...
    anime.timeline({loop: true})
      .add({
        targets: this.walkPlayer,
        x: 200,
        duration: 3000
      })
      .add({targets: this.walkPlayer,
        x: 0,
        duration: 3000
      })
